...
@dataclass
class args:
    result_folder = '../results/Hispanic' 
    figPath = os.path.join(result_folder, 'figures_morris')
    checkpoint_folder = os.path.join(result_folder, 'checkpoints')
    input_filePath = '../2022_May_race_groups/Total.csv'

    configPath = '../configurations/race.json'
    model_path = os.path.join(checkpoint_folder, 'best-epoch=2.ckpt')

    # set this to false when submitting batch script, otherwise it prints a lot of lines
    show_progress_bar = False
    static_feature_index = 3
...
# %%
# delta_values 
delta_values = [-1000e-5, -900e-5, -800e-5, -700e-5, -600e-5, -500e-5, -400e-5, -300e-5, -200e-5, -100e-5, \
                100e-5, 200e-5, 300e-5, 400e-5, 500e-5, 600e-5, 700e-5, 800e-5, 900e-5, 1000e-5]
