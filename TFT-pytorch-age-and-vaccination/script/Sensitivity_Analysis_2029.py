...
class args:
    ...
    model_path = os.path.join(checkpoint_folder, os.listdir('../results/age_groups_2029/checkpoints')[0])
...
result_df.to_csv(os.path.join(args.figPath, 'Morris_2029.csv'), index=False)
result_df
