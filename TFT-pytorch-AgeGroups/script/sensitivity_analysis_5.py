...
@dataclass
class args:
    result_folder = '../results/AGE4049' 
    figPath = os.path.join(result_folder, 'figures_morris_mod_all')
    ...
    model_path = os.path.join(checkpoint_folder, 'best-epoch=13.ckpt')
...
delta_values = [2e-06, 4e-06, 6e-06, 8e-06, 1e-05, 2e-05, 4e-05, 6e-05, \
